        ...
        '<div class="foreground-box-employee-list">' +
            ...
            '<table>' +
                ...
                '<tr>' +
                    ...
                    '<td><div class="yellow-round">o</div>' + employee_2.attend + '%</td>' +
                ...
                '<tr>' +
                    ...
                    '<td><div class="green-round">o</div>' + employee_3.attend + '%</td>' +
                    '<td><div class="green-round">o</div>' + employee_3.punct + '%</td>' +
                    `<td><button class="button-purple" onclick="remove_employee(3);">Remove</button></td>` +
                '</tr>' +
                '<tr>' +
                    '<td>' + employee_4.name + '</td>' +
                    '<td>' + employee_4.certs + '</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_4.attend + '%</td>' +
                ...
                '<tr>' +
                    ...
                    '<td><div class="red-round">o</div>' + employee_10.attend + '%</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_10.punct + '%</td>' +
                    `<td><button class="button-purple" onclick="remove_employee(10);">Remove</button></td>` +
                '</tr>' +
                '<tr>' +
                    '<td>' + employee_11.name + '</td>' +
                    '<td>' + employee_11.certs + '</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_11.attend + '%</td>' +
                ...
                '<tr>' +
                    ...
                    '<td><div class="red-round">o</div>' + employee_12.attend + '%</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_12.punct + '%</td>' +
                    `<td><button class="button-purple" onclick="remove_employee(12);">Remove</button></td>` +
                '</tr>' +
                '<tr>' +
                    '<td>' + employee_13.name + '</td>' +
                    '<td>' + employee_13.certs + '</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_13.attend + '%</td>' +
                ...
                '<tr>' +
                    ...
                    '<td><div class="red-round">o</div>' + employee_14.attend + '%</td>' +
                    '<td><div class="green-round">o</div>' + employee_14.punct + '%</td>' +
                    `<td><button class="button-purple" onclick="remove_employee(14);">Remove</button></td>` +
                '</tr>' +
                '<tr>' +
                    '<td>' + employee_15.name + '</td>' +
                    '<td>' + employee_15.certs + '</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_15.attend + '%</td>' +
                    '<td><div class="yellow-round">o</div>' + employee_15.punct + '%</td>' +
